Sure, here is the revised DevOps-Task in markdown format, with typos fixed, phrasing improved, and deployment section updated to include sudo privileges and Docker installation requirements:
